...
const Resgistro = ({handleAuthentication}) => {
    ...
    const handleRegistro = async () => {
        if (validateFields()) {
          ...
          try {
            ...
            navigation.navigate('Categorias'); // Navegar após registro
          } catch (error) {
            setSnackbarMessage(`Erro ao fazer Registro: ${error.message}`);
            setSnackbarVisible(true);
          } finally {
            setLoading(false);
          }
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                ...
                <TextInput
                    ...
                    secureTextEntry
                    style={styles.input}
                    textColor="#777" // Definindo a cor corretamente
                ...
                >
                    <Text style={{ fontSize: 20, fontWeight: 'bold', color: '#FFF' }}>Registro</Text>
                </Button>


                <Pressable onPress={() => navigation.navigate('Login')}>
                    <Text style={styles.registerText}>
                        Já tem conta? Faça seu Login agora!
                    </Text>
                </Pressable>
            </View>
